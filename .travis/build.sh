...
then
    ...
    ./gradlew --refresh-dependencies --stacktrace clean spotlessCheck pmdMain pmdTest spotbugsMain spotbugsTest allTests jacocoTestReport jacocoTestCoverageVerification
